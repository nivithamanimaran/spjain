  ...
  return (
    <div className={classes.divContent}>
      ...
      <ol start="1" type="1">
        ...
        <li>Ensure that all the connections should be tight.</li>
        <li>
          Check whether the connections are correct by taking out some
          resistance from the resistance box and close the plug key ‘K’.
        </li>
        <li>
        ...
        <li>
          ...
          both the end of the bridge for each wire and also when it is connected
          parallel.
        </li>
        <li>
          To make the parallel connection, just join one end of each resistor to
          a common point and connect in the right gap of the metre bridge.
        </li>
      ...
      <ol start="1" type="1">
        ...
        <li>
          ...
          right side, let take it as “BC” which is (100-<em>l</em>) cm.
        </li>
        <li>
      ...
      <div>
        <table align="center" border="1" cellpadding="0" cellspacing="0">
          <tbody>
            ...
            <tr>
              <td>
                r<sub>1</sub> and r<sub>2 </sub>in parallel
              </td>
              <td>
                1<br />2<br />3
              </td>
      ...
      <ol>
        ...
        <li>
          ...
          <br />
          <br />
          Experimental value of R<sub>p</sub> = ........... ohm
          <br />
          <br />
      ...
      <p>
        ...
        values of R<sub>p</sub> are same. Hence, law of resistances in parallel
        is verified.&nbsp;
      </p>
