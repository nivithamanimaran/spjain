...
export default function Resources() {
  ...
  return (
    <div class="divContent">
      ...
      <ul>
        <li>
          <a href="http://epathshala.nic.in/wp-content/doc/book/flipbook/Class%20XII/12085-Chemistry%20Part_I/Unit_4/index.html">
      ...
      <div className={classes.wrap}>
        ...
        <Typography>
          ...
          amrita.olabs.edu.in/?sub=73&brch=8&sim=143&cnt=380
        </Typography>
      </div>
    </div>
  );
