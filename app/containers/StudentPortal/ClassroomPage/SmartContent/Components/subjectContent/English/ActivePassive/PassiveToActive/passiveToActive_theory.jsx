    ...
    <div class="divContent">
      ...
      <p>
        <span>
          ...
          is performing the action or causing the happening denoted by the verb.
          With the active voice, you learn ‘who’ or ‘what’ is responsible for
          the action at the beginning of the sentence. In other words, the
          subject performs the action denoted by the verb. With help of active
          voice more powerful sentences can be build than passive voice.
        </span>
      </p>
      ...
      <p>
        <span>
          1. Active voice is used in a clause whose subject expresses the agent
          of the main verb.
          <br />
      ...
      <p>
        <span>
          ...
          receiving the action and not on who/what is performing the action. In
          passive voice, the actor of the of the verb (action) is either
          ...
          which the actor is not important or unknown, but the action happening
          on the object is very important.
        </span>
      </p>
      ...
      <p>
        <span>
          ...
          <br />
          3. It is used if we are more interested in the job than the actors who
          work.
        </span>
      </p>
      ...
      <h2 className={classes.secondaryTag}>
        <span>Active/Passive voice using Modals:</span>
      </h2>
        ...
        <tbody>
          <tr>
            <td
              ...
              to=""
            >
              <h2 style={{textAlign: 'center'}} className={classes.secondaryTag}>
                Rules for Active to Passive conversion
              </h2>
            </td>
          </tr>
          <tr>
            <td className={classes.tableContent} data-sheets-value="[null,2,">
              <p>
                <span>
                  <strong>
                    <span>Tense</span>
          ...
          <tr>
            ...
            >
              ...
              <p>
                <span>
                  <span>
                    <strong>E.g.&nbsp;</strong> Fresh vegetables are sold by the
                    grocer.
                  </span>
                </span>
              </p>
          ...
          <tr>
            ...
            >
              ...
              <p>
                <span>
                  <span>
                    <strong>E.g.</strong>&nbsp; Many assignments are being given
                    by my boss.
                  </span>
                </span>
              </p>
          ...
          <tr>
            ...
            >
              ...
              <p>
                <span>
                  <span>
                    <strong>E.g.</strong>&nbsp; A large house was built by him.
                  </span>
                </span>
              </p>
            </td>
          ...
          <tr>
            ...
            >
              <p>
                <span>
                  <span>S + was/were + being + past participle +by object</span>
                </span>
              </p>
              ...
              <p>
                <span>
                  <span>
                    <strong>E.g.</strong>&nbsp; Dinner was being cooked by her.
                  </span>
                </span>
              </p>
            </td>
          ...
          <tr>
            ...
            >
              <h2
                ...
                className={classes.secondaryTag}
              >
                Rules for Pronouns in Passive to Active conversion
              </h2>
            </td>
          </tr>
          <tr>
      ...
      <table border="1" cellpadding="0" cellspacing="0" dir="ltr">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className={classes.tableContent}>&nbsp;</td>
            <td className={classes.tableContent}>&nbsp;</td>
            <td className={classes.tableContent}>&nbsp;</td>
          </tr>
          <tr>
