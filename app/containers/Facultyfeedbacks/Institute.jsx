...
import {
  getInstituteFeedbackDetails,
  postInstituteFeedbackDetails,
...
export default function Program(props) {
  ...
  // const [rate, instituteDetail] = useState('');
  const { instituteDetail } = props;
  ...
  useEffect(() => {
    let parameters = instituteDetail?.parameters;
  ...
  const postFeedback = () => {
    ...
    const data = params?.map(el => {
      return {
        parameter: el?.param,
        instituteId: instituteDetail?.instituteId,
        rating: el?.value,
        programId: programDetail?.programId,
        facultyId: userDetails.ContactId,
      };
    });
    ...
    postInstituteFeedbackDetails({ requestData: [...data] })
      .then(res => {
        console.log('res', res);
          ...
          <Card className={classes.root}>
            <CardContent>
              ...
              <Typography className={classes.title} color="textSecondary">
                Academic Year :{' '}
                <Typography className={classes.sub}>
                  {instituteDetail.startDate} / {instituteDetail.endDate}
                </Typography>
              </Typography>
            </CardContent>
          </Card>
