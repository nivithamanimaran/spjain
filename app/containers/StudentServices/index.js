...
export default function HomePage(props) {
  ...
  const [selectOptions] = useState(['RAISE A CASE', 'MAKE A REQUEST']);
          ...
          <>
            <Grid item md={12}>
              <Box mt={2} mb={2} className={classes.headBox} autoPageSize>
                <Box mb={1}>
                  <KenHeader
                    title={
                      <Typography className={classes.heading}>
                        {t('headings:Select Type of Request')}
                      </Typography>
                    }
                  >
              ...
              {selectedValue === 'books' ? (
                <>
                  <Grid sm={12} x={12}>
                    <form className={classes.form} class="caseform">
