...
const AddYourRequest = () => {
  ...
  const handleSubmit = e => {
    e.preventDefault();
    console.warn('all data', type, value, priority);
        ...
        attachment: [
          {
            ...
            attachmentBody: base64.split('base64,')[1],
          },
        ],
      },
    ];
          ...
          <KenCard>
            <Grid item xs={12} className="grid-main">
              ...
              <div className={classes.createDescription}>
                ...
                transcripts or provisional certificatesssss.
              </div>
              <br />
                  ...
                  <Grid item xs={12} className="group-name">
                      ...
                      <Grid container spacing={2}>
                        <Grid item md={4}>
                          <div className="requirement-div-select">
                            ...
                            <div>
                              {error ? (
                                <label>REASON Can't be Empty</label>
                              ) : (
                                ''
                              )}
                            </div>
                    ...
                    <div className="form-input-group">
                      ...
                      <TextField
                        ...
                        variant="outlined"
                      />
                      {error ? <label>REASON Can't be Empty</label> : ''}
                    </div>
                    ...
                    > */}
                      {/* Attach File */}
                      <Base64 setBase64={setBase64} setFile={setFile} />
                      {/* <input
                        hidden
                        accept="image/*"
                        multiple
            ...
            <Grid>
              ...
              <Grid item xs={12}>
                ...
                <Button
                  ...
                  component="label"
                  className={classes.attachbutton}
                  style={{ height: '22px', fontSize: '10px', width: '100px' }}
                >
                  Attach File
                  <input
                    hidden
                ...
                <span className="message-warning" style={{ fontSize: '10px' }}>
                  File size must be less than 2MB
                </span>
              </Grid>
              <br />
