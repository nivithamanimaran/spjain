...
const AnswerSheetRequest = ({ onGoBack }) => {
  ...
  const columns = React.useMemo(
    () => [
      ...
      {
        Header: 'Answer Sheet',
        accessor: 'answerSheet',
        Cell: ({ row }) =>
          row.original.action === 'Approved' ? <GetAppIcon /> : 'N/A',
      },
    ],
  ...
  return (
    <div>
      ...
      <Dialog open={openDialog} onClose={handleDialogClose}>
        <DialogTitle>Apply for Answer Sheet</DialogTitle>
        <DialogContent>
          ...
          <Grid container spacing={2} className={classes.borderpayment}>
            <Grid item xs={12} md={6}>
              <div className={classes.peranswer}>Per Answer sheet</div>
            </Grid>
            <Grid item xs={12} md={6}>
