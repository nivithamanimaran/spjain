...
export default function FeePayment() {
  ...
  const datas = [
    {
      Fee_Type__c: '2022 BBA Jan Term 5 Course Material Fee',
      currency: 'AUD',
      Planned_Amount_Payable__c: 62.5,
    },
  ]

  return (
    <>
      <div><KenCard paperStyles={{ padding: 16, boxShadow: 'none' }}>
        <div className="KenDivFeeSchedule">
          ...
          //   style: {
          //     textAlign:
          //       cell.id === 'currency_Name' ? 'left' : 'column',
          //     paddingLeft: cell.id === 'currency_Name' ? '50px' : '0px',
          //   },
          // }),
          // getCellProps: cell => ({
          //   style: {
          //     textAlign:
          //       cell.column.id === 'currency_Name' ? 'left' : 'column',
          //   },
          // }),
          // }}
          />
        ...
        <Grid item xs={12} style={{ display: "flex", float: "right" }}>
          <Box textAlign="end" marginTop="15px" style={{ paddingRight: "10px" }}>
        ...
        <Accordion>
          ...
          <KenCard>
            <Grid style={{ display: 'flex' }}>
              ...
              <Grid xs={6}>PAYMENT AMOUNT:</Grid>
            </Grid>
            <Grid style={{ display: 'flex' }}>
              <Grid xs={6}>
                RECIEPT NO:
              </Grid>
              <Grid xs={6}>REMANING AMOUNT</Grid>
            </Grid>
          </KenCard>
        </Accordion>
