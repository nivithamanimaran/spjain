const cryptoJsMin = require("./crypto-js.min");
  ...
  BigBlueButtonApi = (function() {
    ...
    BigBlueButtonApi.prototype.getUrls = function(params, customCalls) {
      ...
      ret = {
        ...
        'join_moderator': joinMod,
        'join_attendee': joinAtt,
        ...
        'join_from_mobile_moderator': joinModMobile,
        'join_from_mobile_attendee': joinAttMobile,
        'mobile_getTimestamp': this.urlForMobileApi("getTimestamp", params),
        'mobile_getMeetings': this.urlForMobileApi("getMeetings", params),
        'mobile_create': this.urlForMobileApi("create", params)
      };
      if (customCalls != null) {
        for (_i = 0, _len = customCalls.length; _i < _len; _i++) {
          call = customCalls[_i];
          ret['custom_call ' + call + ':'] = this.urlFor(call, params, false);
        }
      }
      return ret;
    };
